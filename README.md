...
모든 페이지들은 [https://my-plan-it-client.vercel.app/](https://my-plan-it-client.vercel.app/) 에서 방문 가능합니다. 
...
- **[Axios]()**: 백엔드와 통신을 하기 위한 HTTP 클라이언트 라이브러리로, 자바스크립트 내장 라이브러리인 fetch 함수엔 없는 인터셉터와 더욱 확실한 에러 캐치를 위해 사용했습니다. 
